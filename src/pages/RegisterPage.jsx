...
const RegisterPage = () => {
  ...
  return (
    <div className="max-w-sm mx-auto mt-20 p-8 bg-white rounded-2xl border border-gray-200 shadow-sm">
      ...
      <h2 className="text-2xl font-bold text-center text-gray-900 mb-2">Buat Akun</h2>
      <p className="text-center text-gray-500 text-sm mb-8">Bergabung dengan komunitas kami</p>
      ...
      <form onSubmit={onSubmit} className="space-y-5">
        ...
        <Button type="submit" className="w-full py-3 mt-2">Daftar</Button>
      </form>
      <p className="mt-8 text-center text-gray-500 text-sm">
        Sudah memiliki akun?{' '}
        <Link to="/login" className="text-gray-900 font-semibold cursor-pointer hover:underline underline-offset-4">
          Masuk
        </Link>
      </p>
    </div>
